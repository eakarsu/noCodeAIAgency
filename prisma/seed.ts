...
async function main() {
  ...
  const workflows = [
    ...
    // 13. Contract Review Automation
    {
      name: "Contract Review Automation",
      description: "AI-powered contract review with clause extraction, risk assessment, and approval routing for legal teams",
      status: "ACTIVE" as const,
      nodes: [
        { id: "trigger-1", type: "trigger", position: { x: 250, y: 50 }, data: { label: "Contract Uploaded", config: { trigger: "webhook" } } },
        { id: "ai-1", type: "ai", position: { x: 250, y: 150 }, data: { label: "Extract Clauses", config: { ai_action: "extract" } } },
        { id: "ai-2", type: "ai", position: { x: 250, y: 250 }, data: { label: "Assess Risk Level", config: { ai_action: "classify" } } },
        { id: "transform-1", type: "transform", position: { x: 250, y: 350 }, data: { label: "Generate Summary", config: { transform: "map" } } },
        { id: "condition-1", type: "condition", position: { x: 250, y: 450 }, data: { label: "High Risk?", config: { condition: "riskLevel === 'high'" } } },
        { id: "action-1", type: "action", position: { x: 100, y: 550 }, data: { label: "Escalate to Legal", config: { action: "slack_message" } } },
        { id: "action-2", type: "action", position: { x: 400, y: 550 }, data: { label: "Auto-Approve", config: { action: "update_record" } } },
        { id: "action-3", type: "action", position: { x: 100, y: 650 }, data: { label: "Create Review Task", config: { action: "create_record" } } },
        { id: "action-4", type: "action", position: { x: 250, y: 750 }, data: { label: "Notify Stakeholders", config: { action: "send_email" } } },
        { id: "action-5", type: "action", position: { x: 250, y: 850 }, data: { label: "Archive Contract", config: { action: "upload_file" } } },
        { id: "end-1", type: "end", position: { x: 250, y: 950 }, data: { label: "Review Complete" } },
      ],
      edges: [
        { id: "e1", source: "trigger-1", target: "ai-1" },
        { id: "e2", source: "ai-1", target: "ai-2" },
        { id: "e3", source: "ai-2", target: "transform-1" },
        { id: "e4", source: "transform-1", target: "condition-1" },
        { id: "e5", source: "condition-1", target: "action-1", sourceHandle: "true" },
        { id: "e6", source: "condition-1", target: "action-2", sourceHandle: "false" },
        { id: "e7", source: "action-1", target: "action-3" },
        { id: "e8", source: "action-3", target: "action-4" },
        { id: "e9", source: "action-2", target: "action-4" },
        { id: "e10", source: "action-4", target: "action-5" },
        { id: "e11", source: "action-5", target: "end-1" },
      ],
    },
    ...
    // 14. Multi-Channel Notification System
    {
      ...
      description: "Intelligent notification routing across email, SMS, Slack, and push based on user preferences and urgency",
      status: "ACTIVE" as const,
      nodes: [
        { id: "trigger-1", type: "trigger", position: { x: 250, y: 50 }, data: { label: "Event Received", config: { trigger: "webhook" } } },
        { id: "transform-1", type: "transform", position: { x: 250, y: 150 }, data: { label: "Parse Event Data", config: { transform: "json" } } },
        { id: "action-1", type: "action", position: { x: 250, y: 250 }, data: { label: "Fetch User Preferences", config: { action: "http_request" } } },
        { id: "switch-1", type: "switch", position: { x: 250, y: 350 }, data: { label: "Urgency Level", config: { field: "urgency" } } },
        { id: "action-2", type: "action", position: { x: 50, y: 450 }, data: { label: "Send SMS", config: { action: "twilio_sms" } } },
        { id: "action-3", type: "action", position: { x: 200, y: 450 }, data: { label: "Send Email", config: { action: "send_email" } } },
        { id: "action-4", type: "action", position: { x: 350, y: 450 }, data: { label: "Post to Slack", config: { action: "slack_message" } } },
        { id: "action-5", type: "action", position: { x: 500, y: 450 }, data: { label: "Send Push", config: { action: "http_request" } } },
        { id: "merge-1", type: "merge", position: { x: 250, y: 550 }, data: { label: "Collect Results" } },
        { id: "action-6", type: "action", position: { x: 250, y: 650 }, data: { label: "Log Delivery Status", config: { action: "create_record" } } },
        { id: "end-1", type: "end", position: { x: 250, y: 750 }, data: { label: "Notifications Sent" } },
      ],
      edges: [
        { id: "e1", source: "trigger-1", target: "transform-1" },
        { id: "e2", source: "transform-1", target: "action-1" },
        { id: "e3", source: "action-1", target: "switch-1" },
        { id: "e4", source: "switch-1", target: "action-2" },
        { id: "e5", source: "switch-1", target: "action-3" },
        { id: "e6", source: "switch-1", target: "action-4" },
        { id: "e7", source: "switch-1", target: "action-5" },
        { id: "e8", source: "action-2", target: "merge-1" },
        { id: "e9", source: "action-3", target: "merge-1" },
        { id: "e10", source: "action-4", target: "merge-1" },
        { id: "e11", source: "action-5", target: "merge-1" },
        { id: "e12", source: "merge-1", target: "action-6" },
        { id: "e13", source: "action-6", target: "end-1" },
      ],
    },

    // 15. Inventory Restock Pipeline
    {
      name: "Inventory Restock Pipeline",
      description: "Automated inventory monitoring with demand prediction, supplier ordering, and restock notifications",
      status: "ACTIVE" as const,
      nodes: [
        { id: "trigger-1", type: "trigger", position: { x: 250, y: 50 }, data: { label: "Daily Stock Check", config: { trigger: "schedule" } } },
        { id: "action-1", type: "action", position: { x: 250, y: 150 }, data: { label: "Fetch Inventory Levels", config: { action: "http_request" } } },
        { id: "loop-1", type: "loop", position: { x: 250, y: 250 }, data: { label: "For Each Product", config: { iterations: "products.length" } } },
        { id: "condition-1", type: "condition", position: { x: 250, y: 350 }, data: { label: "Below Threshold?", config: { condition: "stock < reorderPoint" } } },
        { id: "ai-1", type: "ai", position: { x: 100, y: 450 }, data: { label: "Predict Demand", config: { ai_action: "extract" } } },
        { id: "filter-1", type: "filter", position: { x: 400, y: 450 }, data: { label: "Skip Well-Stocked" } },
        { id: "transform-1", type: "transform", position: { x: 100, y: 550 }, data: { label: "Calculate Order Qty", config: { transform: "map" } } },
        { id: "action-2", type: "action", position: { x: 100, y: 650 }, data: { label: "Place Supplier Order", config: { action: "http_request" } } },
        { id: "action-3", type: "action", position: { x: 100, y: 750 }, data: { label: "Update Inventory DB", config: { action: "update_record" } } },
        { id: "action-4", type: "action", position: { x: 100, y: 850 }, data: { label: "Notify Warehouse", config: { action: "slack_message" } } },
        { id: "action-5", type: "action", position: { x: 250, y: 950 }, data: { label: "Send Restock Report", config: { action: "send_email" } } },
        { id: "end-1", type: "end", position: { x: 250, y: 1050 }, data: { label: "Restock Complete" } },
      ],
      edges: [
        { id: "e1", source: "trigger-1", target: "action-1" },
        { id: "e2", source: "action-1", target: "loop-1" },
        { id: "e3", source: "loop-1", target: "condition-1" },
        { id: "e4", source: "condition-1", target: "ai-1", sourceHandle: "true" },
        { id: "e5", source: "condition-1", target: "filter-1", sourceHandle: "false" },
        { id: "e6", source: "ai-1", target: "transform-1" },
        { id: "e7", source: "transform-1", target: "action-2" },
        { id: "e8", source: "action-2", target: "action-3" },
        { id: "e9", source: "action-3", target: "action-4" },
        { id: "e10", source: "action-4", target: "action-5" },
        { id: "e11", source: "filter-1", target: "action-5" },
        { id: "e12", source: "action-5", target: "end-1" },
      ],
    },
  ]
